...
@Route("turnstile-submit")
public class TurnstileSubmitView extends VerticalLayout {
    ...
    public TurnstileSubmitView(@Value("${captcha.turnstile.site-key}") String siteKey,
        ...
        VerticalLayout content = new VerticalLayout(new H1("Cloudflare Turnstile - verify on submit"),
                formContainer);
    ...
    private void buildForm() {
        ...
        submit.addClickListener(event -> {
            ...
            VerificationResult result = new TurnstileVerifier(secret).verify(captcha.getValue());
            if (result.success()) {
