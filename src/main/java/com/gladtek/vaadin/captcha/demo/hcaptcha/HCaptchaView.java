...
@Route("hcaptcha")
public class HCaptchaView extends VerticalLayout {
    ...
    public HCaptchaView(@Value("${captcha.hcaptcha.site-key}") String siteKey,
        ...
        VerticalLayout content = new VerticalLayout(new H1("hCaptcha"), formContainer);
    ...
    private void buildForm() {
        ...
        captcha.addTokenListener(event -> {
            VerificationResult result = new HCaptchaVerifier(secret).verify(event.getToken());
            if (result.success()) {
